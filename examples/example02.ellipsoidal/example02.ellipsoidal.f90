...
! Specific calculation to generate CSV files
    ...
    double precision :: a, b, startingangleofsoidal, endinggangleofsoidal, startinxofsoidal, startinyofsoidal, c
    double precision :: d, startingangle, k, bigf, t, x, y, yprime, tangentangle, normalangle, incidentangle, reflectangle
