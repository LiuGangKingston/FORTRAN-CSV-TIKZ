%   This is the only one tex file of example01.data.splitted for
...
%
%
%   Since data splitted into smaller files, additional 
%   command "\foreach \myfile in {iterated.alldata.0.csv, 
...
%   iterated.alldata.9.csv} { ...} " is added. 
