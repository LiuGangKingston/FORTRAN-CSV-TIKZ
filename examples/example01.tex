...
%
%
%   Since data splitted into smaller files, additional command "\foreach \myfile in {iterated.alldata.0.csv, iterated.alldata.1.csv, iterated.alldata.2.csv, iterated.alldata.3.csv, iterated.alldata.4.csv, iterated.alldata.5.csv, iterated.alldata.6.csv, iterated.alldata.7.csv, iterated.alldata.8.csv, iterated.alldata.9.csv} { ...} " is added. Hope less computer memory is needed.
%
%
% 
%
...
\foreach \myfile in {iterated.alldata.0.csv, iterated.alldata.1.csv, iterated.alldata.2.csv, iterated.alldata.3.csv, iterated.alldata.4.csv, 
iterated.alldata.5.csv, iterated.alldata.6.csv, iterated.alldata.7.csv, iterated.alldata.8.csv, iterated.alldata.9.csv}
{
